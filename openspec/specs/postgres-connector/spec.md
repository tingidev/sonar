# postgres-connector Specification

## Purpose
TBD - created by archiving change postgres-schema-discovery. Update Purpose after archive.
## Requirements
